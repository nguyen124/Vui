...
namespace Vui.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        [HttpPost]
        public ActionResult UpdateInfo(HttpPostedFileBase FileUpload)
        {
            ...
            string AdminRole = Request.Form["AdminRole"];
            string ModRole = Request.Form["ModRole"];
            string UserRole = Request.Form["UserRole"];
            //string Avatar = Request.Form["Avatar"];
            string submit = Request.Form["SubmitBtn"];
            if (submit == "Cancle")
            {
            ...
            {
                ApplicationUser user = db.Users.Where(us => us.Id == UserId).First();
                ...
                user.Email = Email;
                user.LockoutEnabled = (Active == "ON" ? true : false);
                db.SaveChanges();
                if (AdminRole != null)
                {
                ...
                if (ModRole != null)
                {
                    userManager.AddToRole(user.Id, ModRole);
                }
                else
                {
                    userManager.RemoveFromRoles(user.Id, "Mod");
                }
                if (UserRole != null)
                {
